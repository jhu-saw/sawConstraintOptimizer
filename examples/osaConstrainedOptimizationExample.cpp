...
// not used here but included to make sure code compiles
#include <sawConstraintOptimizer/osaConstraintPlane.h>
#include <sawConstraintOptimizer/osaObjectiveFreeMotion.h>
