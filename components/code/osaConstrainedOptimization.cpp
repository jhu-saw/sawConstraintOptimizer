...
osaConstrainedOptimization::Insert(osaEquation* e)
{
    if (e == NULL) {
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Insert(osaObjective* o)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Insert(osaConstraintEquality* ce)
{
    std::pair<std::map<std::string, osaEquation*>::iterator, bool> r;
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Insert(osaConstraintInequality* ci)
{
    std::pair<std::map<std::string,osaEquation*>::iterator, bool> r;
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Remove(const std::string& name)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Remove(osaEquation* eq)
{
    return Remove(eq->GetName());
}

osaConstrainedOptimization::Errno
osaConstrainedOptimization::Remove(osaObjective* eq)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Remove(osaConstraintEquality* eq)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Remove(osaConstraintInequality* eq)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Activate(const std::string& name)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::DeActivate(const std::string& name)
{
    std::map<std::string, osaEquation*>::iterator o = objectives.find(name);
    if (o != objectives.end()) {
        o->second->DeActivate();
...
size_t osaConstrainedOptimization::CountActiveObjectives(void) const
{
    size_t cnt = 0;
    std::map<std::string,osaEquation*>::const_iterator oi;
    for (oi = objectives.begin();
         oi != objectives.end(); oi++) {
        if (oi->second->IsActive()) {
            cnt += oi->second->GetNumEquations();
        }
    }
    return cnt;
}

size_t osaConstrainedOptimization::CountActiveEqualities(void) const
{
    size_t cnt = 0;
    std::map<std::string,osaEquation*>::const_iterator ei;
    for (ei = equalities.begin();
         ei != equalities.end();
         ei++) {
        if (ei->second->IsActive()) {
            cnt += ei->second->GetNumEquations();
        }
    }
    return cnt;
}
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::ObjectivesDimension(size_t& N) const
{
    N = 0;
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::EqualitiesDimension(size_t& N) const
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::InequalitiesDimension(size_t& N) const
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::UpdateObjectivesSystem(void)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::UpdateEqualitiesSystem(void)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::UpdateInequalitiesSystem(void)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::UpdateObjectives(void)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::UpdateEqualities(void)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::UpdateInequalities(void)
{
...
osaConstrainedOptimization::Errno
osaConstrainedOptimization::Evaluate(vctDynamicVector<double>& x)
{
